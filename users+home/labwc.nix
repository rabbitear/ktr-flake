...
# wlrctl activate app_id:"${input}"
  ...
  wayland.windowManager.labwc = {
    ...
    autostart = [
      ...
      "foot --app-id=journalfollow --maximized --title=journalfollow --override='main.font=monospace=11' --override='colors.background=000000' --override='colors.alpha=0.1' journalctl -f 2>/dev/null &"
    ];
    environment = [
