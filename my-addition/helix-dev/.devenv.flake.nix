{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/kreator/docs/ktr-flake/my-addition/helix-dev";
  project_input_ref = "path:/home/kreator/docs/ktr-flake/my-addition/helix-dev";
  devenv_dotfile = "/home/kreator/docs/ktr-flake/my-addition/helix-dev/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-bc98e30";
  ...
  hostname = "sasha";
  username = "kreator";
  git_root = "/home/kreator/docs/ktr-flake";
  secretspec = null;
};
    in
    {
