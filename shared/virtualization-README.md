...
### 1. **Virtualization Module** (`shared/services/virtualization.nix`)
...
### 2. **Base Image Scripts** (`my-addition/scripts/vm-scripts/`)
...
1. Run `./my-addition/scripts/vm-scripts/create-all-images.sh` to create base images
